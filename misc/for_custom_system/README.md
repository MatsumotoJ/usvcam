## Utilities and information for converting data captured with your custom system (one camera + one microphone array) into data format for analysis with USVCAM
